...
enum SubcommandType
{
	CLOSEST()
			{
				@Override
				Subcommand create(final SavageGraveyardsPluginController.CommandContextContainer ctx)
				{
	...
	abstract Subcommand create(final SavageGraveyardsPluginController.CommandContextContainer ctx);
