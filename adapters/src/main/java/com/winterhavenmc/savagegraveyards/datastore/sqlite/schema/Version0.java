...
public class Version0
{
	...
	{
		private final static String selectAllQueryKey = "SelectAllDiscoveryRecordsV0";


		public String selectAllQueryKey()
		{
			return selectAllQueryKey;
		}
		...
		public Discovery map(ResultSet resultSet) throws SQLException
		{
			...
			UUID playerUid = UUID.fromString(resultSet.getString(Column.PLAYER_UID_STRING.label()));
	...
	{
		private final static String selectAllQuery = "SelectAllGraveyardRecordsV0";
