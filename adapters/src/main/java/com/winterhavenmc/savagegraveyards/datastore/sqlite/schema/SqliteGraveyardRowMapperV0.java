...
public final class SqliteGraveyardRowMapperV0 implements GraveyardRowMapper
{
	/**
	...
	public Graveyard map(final ResultSet resultSet) throws SQLException
	{
		...
		return switch (graveyardName)
		{
			...
			case ValidDisplayName validGraveyardName ->
			{
				...
				{
					case InvalidLocation ignored -> new InvalidGraveyard(graveyardName, UNKNOWN_WORLD_NAME, FailReason.PARAMETER_INVALID, Parameter.LOCATION);
