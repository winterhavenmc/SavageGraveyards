...
public class MetricsHandler
{
	public MetricsHandler(final MetricsCtx ctx)
	{
		...
		metrics.addCustomChart(new SingleLineChart("total_graveyards", () -> ctx.graveyards().getCount()));

		// total number of graveyards as pie chart
		metrics.addCustomChart(new SimplePie("graveyard_count", () -> String.valueOf(ctx.graveyards().getCount())));
