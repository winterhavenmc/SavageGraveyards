...
{
	public Attributes(final Plugin plugin)
	{
		this(Enabled.of(plugin.getConfig().getBoolean("default-enabled")),
				Hidden.of(plugin.getConfig().getBoolean("default-hidden")),
				DiscoveryRange.of(plugin.getConfig().getInt("discovery-range")),
				DiscoveryMessage.of(""),
				RespawnMessage.of(""),
				Group.of(""),
				SafetyRange.of(50),
